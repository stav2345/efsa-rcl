...
/**
 * Combo box which allows selecting a {@link Selection} object from an .xml
 * list. The data are retrieved from the .xml in the data folder. Please specify
 * in {@link #getSelectionListId()} the code of the .xml which contains the list
 * of interest (see {@link CatalogLists})
 * 
 * @author avonva
 * @author shahaal
 *
...
public class CatalogComboViewer {
	...
	/**
	 * Create a combo box which allows selecting a monitoring method
	 * 
	 * @param parent
	 */
	...
	/**
	 * Set a listener which is called if the combo box selection is changed
	 * 
	 * @param listener
	 */
