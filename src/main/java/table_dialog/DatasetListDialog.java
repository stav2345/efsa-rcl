...
public class DatasetListDialog {
	...
	private void create() {
		...
		this.table = new TableViewer(dialog,
		...
		// allow download of selected report with double click
	...
	/**
	 * method used for downloading a report
	 * 
	 * @author shahaal
	 */
	private void downloadReport() {
		...
		if (selection.isEmpty()) {
			Warnings.warnUser(dialog, Messages.get("error.title"), Messages.get("dataset.not.selected"));
			return;
		}
