 ...
 * {@link #addHelp(String)} {@link #addLabel(String)}
...
public class DialogBuilder {
	...
	/**
	 * Set a label provider for the validator column (only available if the table is
	 * editable)
	 * 
	 * @param validator
	 */
	...
	/**
	 * Get the composite of the builder in order to add custom elements to it
	 * 
	 * @return
	 */
	...
	public DialogBuilder addGroupToComposite(String code, String compositeCode, String groupTitle, Layout layout,
			GridData data) {
	 ...
	 * @return
	 */
	public DialogBuilder addButtonToComposite(String code, String compositeCode, String text, MouseListener listener) {
	...
	/**
	 * Add a row creator with selector. {@code selectionListCode} identifies an xml
	 * list for the combo box. All the values in the list will be picked up.
	 * 
	 ...
	 * @param selectionListCode
	 */
	public DialogBuilder addRowCreatorToComposite(String compositeCode, String label, String selectionListCode) {
	...
	/**
	 * Add a row creator with selector. {@code selectionListCode} identifies an xml
	 * list for the combo box. {@code selectionId} identifies a sub node of the xml
	 * list and allows taking just the values under the matched node.
	 * 
	 * @param selectionListCode
	 * @param selectionId
	 */
	 ...
	 * @param visible true to show the password in plain text, false to show it as
	 *                dots
	 * @return
	 */
	...
	/**
	 * Listener called when the input of the table changes
	 * 
	...
	/**
	 * Check if all the mandatory fields of the table are fullified
	 * 
	 * @return
	 */
	...
	/**
	 * Listener called when the {@link #catalogSelector} changes selection
	 * 
	 * @param listener
	 */
