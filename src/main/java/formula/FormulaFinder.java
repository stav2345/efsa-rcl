...
public class FormulaFinder {
	 ...
	 */
	/*
	 * @Deprecated public static FormulaList findFunctionFormulas(String text)
	 * throws FormulaException {
	 * 
	 * FormulaList formulas = new FormulaList();
	 * 
	 * // regex to match function names StringBuilder regex = new StringBuilder();
	 * 
	 ...
	 * 
	 * regex.append("\\(") // open function bracket
	 * .append("(").append(operand).append(",)*?") .append(operand) .append("\\)");
	 * // close function bracket
	 * 
	 * String pattern = regex.toString();
	 * 
	 * Pattern p = Pattern.compile(pattern); Matcher m = p.matcher(text);
	 * 
	 * FunctionFormula funcFormula = new FunctionFormula(formula);
	 * formulas.add(funcFormula);
	 * 
	 ...
	 * @throws FormulaException
	 */
	public static FormulaList findColumnFormulas(String text) throws FormulaException {
	 ...
	 * @throws FormulaException
	 */
	public static FormulaList findRelationFormulas(String text, ITableDaoService daoService) throws FormulaException {
	 ...
	 * @throws FormulaException
	 */
	public static FormulaList findComparatorFormulas(String text, String operator) throws FormulaException {
	 ...
	 * @throws FormulaException
	 */
	public static FormulaList findKeywordFormulas(String text) throws FormulaException {

		FormulaList formulas = new FormulaList();

		// search for keywords
		StringBuilder sb = new StringBuilder();
		sb.append("(").append(toRegex(KeywordFormula.APP_NAME_KEYWORD)).append("|")
				...
				.append(toRegex(KeywordFormula.NULL_KEYWORD)).append("|").append(toRegex(KeywordFormula.CONCAT_KEYWORD))
				.append("|").append(toRegex(KeywordFormula.TODAY_KEYWORD)).append("|")
				...
				.append(toRegex(KeywordFormula.LAST_MONTH_YEAR_LABEL_KEYWORD)).append(")");
	 ...
	 * @throws FormulaException
	 */
	public static FormulaList findRowKeywordFormulas(String text) throws FormulaException {

		FormulaList formulas = new FormulaList();

		// search for keywords
		StringBuilder sb = new StringBuilder();
		sb.append("(").append(toRegex(RowKeywordFormula.ROW_ID_KEYWORD)).append(")");
