...
public interface IFormulaService {
	...
	/**
	 * Initialise the row with the default values
	 * note that this will override all the values of the row
	 * with their default values!
	 */
	public void Initialise(TableRow row);
	
	/**
	 * Initialise the values of the row solving the
	 * default values formulas
	 * @param row
	 * @param colId
	 */
	public void Initialise(TableRow row, String colId);
}
