...
/**
 * Class which models a single node of a configuration .xml file It also
 * represents a single cell of the report (i.e. a value of a column of the
 * report table)
 * 
 * @author avonva
 * @author shahaal
...
public class Selection {
	...
	public boolean equals(Object arg0) {
		...
		if (arg0 instanceof Selection) {
			...
			return other != null && other.getCode() != null && other.getCode().equals(code);
		} else
